from data_cience import calcular_alianzas, calcular_alianzas2, calcular_fortalezas, calcular_open_access, calcular_prestigio_author_de_una_institucion, data_ciencie
