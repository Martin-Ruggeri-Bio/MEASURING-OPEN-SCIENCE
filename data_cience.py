...
def data_ciencie(json_papers):
    ...
    #Guarda un primer dataframe general
...
def calcular_alianzas(json_papers):
    ...
    json_papers = json.loads(json_papers)
    df = json_normalize(json_papers)
    #filtro por pais agrupo por categoria y calculo metrica de las citas dadas
...
def calcular_fortalezas(json_papers):
    ...
    json_papers = json.loads(json_papers)
    df = json_normalize(json_papers)
    #filtro por fecha y categoria y ordeno por pais agrupo por paises y calculo todas las metrica de las citaciones que han tenido dichos paises
